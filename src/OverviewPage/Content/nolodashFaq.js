...
**Why copy-paste from this webpage instead of from Lodash's source code directly? That way you get Lodash's exact behavior.**
  ...
  * This website doesn't just provide copy-paste solutions. It also explains ways to tailor the solution to your needs ([example](#!/nolodash/cloneDeep)), and sometimes shows multiple solutions ([example](https://thescottyjam.github.io/snap.js/#!/nolodash/isMap)). It'll also explain modern best-practices and explain why some of Lodash's behaviors may not always be the smartest to mimic ([example](/#!/nolodash/omit)).
